...
shinyUI(navbarPage(theme = "style.css",
                   ...
                   tabPanel("Vous etes proprietaire",
                            h1("Vous voulez louer un logement a New-York ?",style = "font-family: 'Bookman, URW '; font-size : 20pt; color: #FF3399 ; text-align: center"),
                            column(width=6,
                                   radioButtons(
                                     inputId = "arr",
